...
-- HỆ THỐNG FLASHMART (ĐÃ TỐI ƯU VÀ SỬA LỖI)
...
-- ========================================================
-- BÁO CÁO 1: Sửa lỗi cho Marketing (Giữ lại Charlie với total_orders = 0)
-- ========================================================
...
-- ========================================================
-- BÁO CÁO 2: Sửa lỗi cho Kho vận (Tìm sản phẩm chưa từng bán - Anti-Join)
-- ========================================================
